    ...
    <Dialog open={!!orderId} onOpenChange={handleClose}>
      <DialogContent className="w-[400px] max-w-[400px] h-auto p-0 rounded-2xl overflow-hidden shadow-[0px_20px_24px_-4px_rgba(10,13,18,0.08),0px_8px_8px_-4px_rgba(10,13,18,0.03),0px_3px_3px_-1.5px_rgba(10,13,18,0.04)]">
        <DialogHeader className="relative items-start px-6 pt-6 pb-0 gap-4 overflow-visible isolate">
          ...
          <div className="relative z-[1] w-12 h-12 bg-ui-background-error border-8 border-ui-background-error-light rounded-[28px] flex items-center justify-center">
            <Trash2 className="w-6 h-6 text-destructive-primary" />
          </div>

          <div className="relative z-[1] flex flex-col items-start gap-0.5 w-full">
            <DialogTitle className="text-text-primary text-base leading-6 font-semibold">
              Usuń zamówienie
            </DialogTitle>
            <p className="text-text-quaternary text-sm leading-5 font-normal">
        ...
        <div className="flex flex-col pt-8 pb-0">
          <div className="flex flex-row items-start px-6 pb-6 gap-3">
            <Button
              variant="outline"
              className="flex-1 h-11 px-4 py-2.5 bg-white border border-ui-border-light shadow-[0px_1px_2px_rgba(10,13,18,0.05),inset_0px_0px_0px_1px_rgba(10,13,18,0.18),inset_0px_-2px_0px_rgba(10,13,18,0.05)] rounded-lg"
              onClick={handleClose}
              disabled={isDeleting}
            >
              <span className="text-text-quinary text-base leading-6 font-semibold">
                Anuluj
              </span>
            </Button>

            <Button
              className="flex-1 h-11 px-4 py-2.5 bg-destructive-primary hover:bg-destructive-hover shadow-[0px_1px_2px_rgba(10,13,18,0.05),inset_0px_0px_0px_1px_rgba(10,13,18,0.18),inset_0px_-2px_0px_rgba(10,13,18,0.05)] rounded-lg flex items-center justify-center gap-1.5"
